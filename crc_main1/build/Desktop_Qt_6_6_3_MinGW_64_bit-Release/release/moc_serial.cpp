...
Q_CONSTINIT static const qt_meta_stringdata_CLASSSerialENDCLASS_t qt_meta_stringdata_CLASSSerialENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(7, 11),  // "serialError"
        QT_MOC_LITERAL(19, 0),  // ""
        QT_MOC_LITERAL(20, 5),  // "error"
        QT_MOC_LITERAL(26, 17),  // "handleSerialError"
        QT_MOC_LITERAL(44, 28)   // "QSerialPort::SerialPortError"
    },
    "Serial",
    "serialError",
    "",
...
void Serial::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->serialError((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Serial::serialError; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Serial::serialError(QString _t1)
{
